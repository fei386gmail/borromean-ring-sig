    ...
    publications {
        ...
        withType<MavenPublication> {
            ...
            pom {
                ...
                description.set("Threshold Encryption using secp256k1")
                url.set("https://github.com/weavechain/borromean-ring-sig")
                licenses {
                    license {
                        name.set("MIT")
                ...
                issueManagement {
                    system.set("Github")
                    url.set("https://github.com/weavechain/borromean-ring-sig/issues")
                }
                scm {
                    connection.set("scm:git:git://github.com/weavechain/borromean-ring-sig.git")
                    developerConnection.set("scm:git:git@github.com:weavechain/borromean-ring-sig.git")
                    url.set("https://github.com/weavechain/borromean-ring-sig")
                }
                developers {
                    developer {
...
tasks {
    ...
    val releaseJar by creating(Jar::class) {
        archiveClassifier.set("borromean-ring-sig")
